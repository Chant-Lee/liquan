package com.skyjoo.skyper.biz.common.upload;
...
public class UploadManagerImpl implements UploadManager {
    ...
    public UploadFilesResult uploadFiles(MultipartFile[] multipartFiles, String subPath,
        ...
        for (MultipartFile multipartFile : list) {
            ...
            if (!uploadResult.isSuccess()) {
            	return new UploadFilesResult(uploadResult.getErrorCode(), uploadResult.getErrorMsg());
            }
    ...
    public UploadFileResult uploadFile(MultipartFile multipartFile, String subPath,
       ...
       // String fileName = genratorUploadFileName(multipartFile); //随机文件名
