package com.skyjoo.skyper.biz.common.page;

import java.util.List;

import com.skyjoo.skyper.biz.common.DomainBase;
...
public abstract class SimplePage<T> extends DomainBase implements Paginable<T> {
    ...
    public boolean isFirstPage() {
        return pageNo <= PAGE_COUNT;
    }

    public boolean isLastPage() {
        return getTotalPage() <= ((pageNo-1)/PAGE_COUNT+1)*PAGE_COUNT;
    }
